...
pub async fn pwm_set_dutycycle(slice: Peri<'static, PWM_SLICE2>, pin: Peri<'static, PIN_4>) {
  ...
  let desired_freq_hz = 0.5;
  let clock_freq_hz = embassy_rp::clocks::clk_sys_freq();
  let divider = 255u8;
  let period = (clock_freq_hz as f64 / (desired_freq_hz * divider as f64)) as u16 - 1;
  info!("{}, {}, {}, {}", desired_freq_hz, clock_freq_hz, divider, period);
